...
public class ChooseAreaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//已经显示了城市，且不是从weatherActivity跳转过来的就显示天气
	...
	//查询选中省所有的市，优先从数据库查询，如果没有查询到再去服务器查询。。。
	...
	//查询所有的县，优先从数据库中查询，如果查询不到再去服务器上查询。。
	...
	//捕获back按键，根据当前的级别来判断，此时应该返回的是市列表、省列表，还是直接退出
